...
public class BoxUser extends BoxUserBase {
    ...
    /**
     * Get the language of this user. This uses <a href="http://en.wikipedia.org/wiki/ISO_639-1">ISO 639-1 Language Code</a>
     * 
     * @return the language
     */
     ...
     *            the can_see_managed_users to set
     */
    @JsonProperty(FIELD_CAN_SEE_MANAGED_USERS)
     ...
     *            the is_exempt_from_device_limits to set
     */
    @JsonProperty(FIELD_EXEMPT_FROM_DEVICE_LIMITS)
     ...
     *            the is_exempt_from_login_verification to set
     */
    @JsonProperty(FIELD_EXEMPT_FROM_LOGIN_VERIFICATION)
